...
part of 'plugin_model_cache.dart';
...
class PluginModelCache extends _PluginModelCache
  ...
  @override
  Stream<RealmObjectChanges<PluginModelCache>> get changes =>
      RealmObjectBase.getChanges<PluginModelCache>(this);

  @override
  Stream<RealmObjectChanges<PluginModelCache>> changesFor([
    List<String>? keyPaths,
  ]) => RealmObjectBase.getChangesFor<PluginModelCache>(this, keyPaths);

  @override
  PluginModelCache freeze() =>
      RealmObjectBase.freezeObject<PluginModelCache>(this);
  ...
  static EJsonValue _toEJson(PluginModelCache value) => value.toEJson();
  static PluginModelCache _fromEJson(EJsonValue ejson) {
  ...
  static final schema = () {
    RealmObjectBase.registerFactory(PluginModelCache._);
