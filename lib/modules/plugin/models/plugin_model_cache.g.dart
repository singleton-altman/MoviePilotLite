...
class PluginModelCacheAdapter extends TypeAdapter<PluginModelCache> {
  @override
  final typeId = 2;

  @override
  PluginModelCache read(BinaryReader reader) {
    final numOfFields = reader.readByte();
    final fields = <int, dynamic>{
      for (int i = 0; i < numOfFields; i++) reader.readByte(): reader.read(),
    };
    return PluginModelCache(
      fields[0] as String,
      fields[1] as String,
      fields[2] as String,
      fields[3] as String,
  ...
  bool operator ==(Object other) =>
      ...
      other is PluginModelCacheAdapter &&
